...
function workflowsRouterFactory (taskgraphRunner, presenter, waterline) {
    ...
    /**
     * @api {get} /api/common/workflows/library PUT /
     * @apiDescription define a new workflow
     * @apiName workflows-define
     * @apiGroup workflows
     */

    router.put('/workflows/', presenter.middleware(function (req) {
        return taskgraphRunner.defineTaskGraph(req.body);
    }));

    /**
     * @api {get} /api/common/workflows/tasks PUT /tasks
     * @apiDescription get list of workflow possible to run
     * @apiName workflowTasks-define
     * @apiGroup workflowTasks
     */

    router.put('/workflows/tasks', presenter.middleware(function (req) {
        return taskgraphRunner.defineTask(req.body);
    }));


    /**
     * @api {get} /api/common/workflows/tasks/library GET /tasks/library
    ...
    router.get('/workflows/:identifier', presenter.middleware(function (req) {
        return waterline.graphobjects.findByIdentifier(req.param('identifier'));
    }));
