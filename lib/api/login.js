...
function loginRouterFactory (
     ...
     * @apiName login-get
     * @apiGroup login
     * @apiParam {query} username username used to login
     * @apiParam {query} password password used to login
    ...
    router.get('/login', authService.authMiddlewareLogin.bind(authService));
