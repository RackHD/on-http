...
function dhcpRouterFactory (dhcpProtocol, presenter, assert, _) {
     ...
     * @apiSuccess {json} lease The dhcp lease with the <code>mac</code> or an empty object if there is none with that <code>mac</code>.
     */
     ...
     * @apiSuccess {json} lease The dhcp lease with the <code>ip</code> or an empty object if there is none with that <code>ip</code>.
     */
     ...
     * @apiGroup dhcp
     * @apiSuccess {json} lease The dhcp pinned with the <code>ip</code> or an empty object if there is none with that <code>ip</code>.
     * @apiError AssertionError The <code>ip</code> is not a valid IP
     */
