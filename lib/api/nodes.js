...
function nodesRouterFactory (
     ...
     * @apiError E_VAILIDATION <codeidentifiers</code> expect a string or an array of strings.
     * @apiErrorExample E_VAILIDATION:
     * {
     *      "error": "E_VALIDATION",
     *      "status": 400,
     ...
     * @apiGroup nodes
     * @apiParam {String} identifier node identifier
     * @apiSuccess {json} obmSettings The list of ObmSettings that the node with <code>identifier</code> has.
     ...
     * @apiGroup nodes
     * @apiParam {String} identifier node identifier
     * @apiSuccess {json} node The updated node with <code>identifier</code> with the added ObmSetting.
     * @apiError NotFound The node with the <code>identifier</code> was not found.
     * @apiErrorExample {json} Error-Response:
     *     HTTP/1.1 404 Not Found
     *     {
     ...
     * @apiGroup nodes
     * @apiParam {String} identifier node identifier
     * @apiSuccess {json} pollers list the pollers or an empty object is there are none for the node with <code>identifier</code>.
     * @apiError NotFound The node with the <code>identifier</code> was not found.
     * @apiErrorExample {json} Error-Response:
     *     HTTP/1.1 404 Not Found
     *     {
    ...
    /**
     * @api {get} /api/1.1/nodes/:identifier/files GET /:identifier/files
     * @apiVersion 1.1.0
     ...
     * @apiSuccess {json} files list the filess or an empty object is there are none for the node with <code>identifier</code>.
     * @apiError NotFound The node with the <code>identifier</code> was not found.
     * @apiError RetrievingError was not able to retrieve the files from the database.
     * @apiErrorExample {json} Error-Response:
     *     HTTP/1.1 500 Error
     *     {
    ...
    /**
     * @api {put} /api/1.1/nodes/:identifier/files PUT /:identifier/files
     * @apiVersion 1.1.0
     ...
     * @apiError Error problem was encountered, file was not written.
     * @apiError NotFound The node with the <code>identifier</code> was not found.
     * @apiErrorExample Error-Response:
     *     HTTP/1.1 500 Error
     *     {
    ...
    /**
     * @api {delete} /api/1.1/nodes/:identifier/files DELETE /:identifier/files
     * @apiVersion 1.1.0
     ...
     * @apiError Error Any problem was encountered, file was not deleted.
     * @apiError NotFound The node with the <code>identifier</code> was not found.
     * @apiErrorExample Error-Response:
     *     HTTP/1.1 500 Error
     *     {
     ...
     * @apiSuccess {json} workflows the list of workflows or an empty object if there isn't any for the node.
     * @apiError NotFound The node with the <code>identifier</code> was not found.
     * @apiErrorExample Error-Response:
     *     HTTP/1.1 404 Not Found
     *     {
     ...
     * @apiError NotFound1 The node with the <code>identifier</code> was not found.
     * @apiError NotFound2 The node with the <code>identifier</code> does not have an active workflow.
     * @apiErrorExample Error-Response:
     *     HTTP/1.1 404 Not Found
     *     {
     *       "error": "Not Found"
