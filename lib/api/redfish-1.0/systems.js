        ...
        if(result.isDell){
            ...
            .then(function(smart) {
                for(var i = 0; i < smart.data.length; i++) {
                    ...
                    var id = drive.SMART.Identity["Serial number"];
            ...
            .then(function(drive) {
                ...
                options.serialNumber = driveIdenity["Serial number"];
                options.manufacturer = driveIdenity["Vendor"];
                options.blockSizeInBytes = driveIdenity["Logical block size"].split(" ")[0];
                options.model = driveIdenity["Product"];
