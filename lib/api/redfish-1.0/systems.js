...
var getSystem = controller(function(req, res) {
    ...
    .then(function(result){
        ...
        if(result.vendor === 'Dell'){
	     ...
	     return dataFactory(identifier,'UCS').then(function(data){
                options.skuInfo = node.sku === undefined ? "": node.sku;
		 return redfish.render('ucs.1.0.0.computersystem.1.0.0.json',
				'ComputerSystem.v1_3_0.json#/definitions/ComputerSystem',
                               _.merge(options, data));
	    });
	}else {
