...
function pollerRouterFactory (waterline, presenter, taskProtocol, Constants, Q, _) {
    ...
    function deserializePoller(poller) {
        ...
        poller.name = pollerWorkItems[poller.name];
        return poller;
    }

    function serializePoller(poller) {
        poller.name = _.findKey(pollerWorkItems, function (workItem) {
    ...
    /**
     * @apiGroup pollers
     * @api {patch} /api/common/pollers/:identifier PATCH /:identifier
