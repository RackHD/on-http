    ...
    var obms = [
        ...
        },
        {
            ...
            config: {
                ...
                pduOutlets: [
                    //host/community/cyclePassword defined inside pduOutlets array are optional. They will
                    //override the settings above, if they exist inside the array below.
                    //In this case, different outlets for a node can be distributed into different
                    //IPI PDU for full-failover configurations.
                    //By default, the cyclePassword for each outlet is a string of 'A<outlet_number>'
                    //outlet_number is a double-digital number, ie. 00, 01, 12, 24.
                    {
                        host: {
                            default: 'localhost',
                            type: 'string'
