...
function CommonStompResources(
  ...
  PostalResource) {
    ...
    Object.defineProperties(this, {
        ...
        PostalResource: { value: PostalResource },
...
CommonStompResources.prototype.register = function register(stomp) {
    ...
    var PostalResource = self.PostalResource;
    var constants = self.constants;

    var nodes = self.injector.get(factories.nodes);
    var workflows = self.injector.get(factories.workflows);
    var pollers = self.injector.get(factories.pollers);
    var internallog = new PostalResource({
...
CommonStompResources.prototype.unregister = function unregister(stomp) {
    ...
    if (self.resources) {
        ...
        stomp.unregister(self.resources.workflows);
        stomp.unregister(self.resources.pollers);
        stomp.unregister(self.resources.logging);
        self.resources = null;
    }
};
