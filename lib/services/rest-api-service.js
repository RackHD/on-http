...
function restFactory(BaseSerializable, Q, _, assert, util, Errors, Logger, injector) {
    ...
    rest.deserialize = function (deserializer) {
        ...
        return rest.async(function deserializeMiddleware(req) {
            if (deserializer) {
                ...
                return Q.resolve(deserializer(req.body, options))
                .then(function (value) {
                    req.originalBody = req.body;
                    req.body = value;
                }).catch(function (err) {
                    // TODO - replace this with an error serializer
    ...
    rest.exec = function (callback) {
        ...
        return rest.async(function execMiddleware(req, res) {
            return Q.resolve(callback(req, res))
            .then(function (value) {
                res.body = value;
            });
        });
    ...
    rest.serialize = function (serializer) {
        ...
        return rest.async(function serializeMiddleware(req, res) {
            if (serializer) {
                return Q.resolve(serializer(res.body))
                .then(function (value) {
    ...
    rest.serializeArray = function (serializer) {
        return rest.serialize(function (data) {
            ...
            if (serializer) {
                return Q.all(_.map(data, function (record) {
    ...
    rest.createDeserializeFunc = function (Deserializer) {
        ...
        assert.ok(deserializer instanceof BaseSerializable,
                 'deserializer is an instance of BaseSerializable');
    ...
    rest.createSerializeFunc = function (Serializer) {
        ...
        assert.ok(serializer instanceof BaseSerializable,
                 'serializer is an instance of BaseSerializable');
