    ...
    return {
        ...
        mq: {
            query: function (msg, wsConn, rawMsg) {
                logger.warn('MQ resource does not support query method.', {
                    rawMessage: rawMsg
                });
            },
            all: function (msg, wsConn) {
                logger.warn('MQ resource does not support all method.', {
                    rawMessage: rawMsg
                });
            },
            get: function (msg, wsConn) {
                logger.warn('MQ resource does not support get method.', {
                    rawMessage: rawMsg
                });
            },
