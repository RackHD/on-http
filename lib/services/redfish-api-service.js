...
function redfishApiServiceFactory(
    ...
    RedfishApiService.prototype.getRedfishCatalog = function (req, res) {
        ...
        var typeId = identifier.split(['-'])[0];
        var newId = typeId.replace(req.swagger.params.type.raw, '');
        var catalogSource = req.url.replace(req.swagger.params.identifier.value, newId);
    ...
    RedfishApiService.prototype.getRedfishNetworkCatalog = function (req, res) {
        var identifier = req.swagger.params.identifier.value;
        var nodeId = identifier.split(['-'])[1];
        var networkId = identifier.split(['-'])[0];
        var catalogSource = req.url.replace(req.swagger.params.identifier.value, networkId);
