...
function httpServiceFactory(
    ...
    app.listen = function() {
        ...
        // create a wrapper for swagger.create() that will return a promise
        var swaggerWrapper = function () {
            return new Promise(function (resolve, reject) {
                swagger.create(swaggerConfig,
                    function (err, swaggerExpress) {
                        return err ? reject(err) : resolve(swaggerExpress);
                    }
                );
            });
        };

        // add promise for swagger registration to the list of returned promises.
        promises.push(swaggerWrapper().then(function (swaggerExpress) {
