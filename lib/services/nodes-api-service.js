...
function nodeApiServiceFactory(
    ...
    NodeApiService.prototype.patchNodeById = function(req) {
    ...
    NodeApiService.prototype.getNodeObmById = function(req) {
        return waterline.nodes.needByIdentifier(req.params.identifier)
            .then(function (node) {
                if (node) {
    ...
    NodeApiService.prototype.postNodeObmById = function(req) {
        return waterline.nodes.needByIdentifier(req.params.identifier)
            .then(function (node){
    ...
    NodeApiService.prototype.postNodeObmIdById = function(req) {
    ...
    NodeApiService.prototype.getNodeCatalogSourceById = function(req) {
        return waterline.nodes.needByIdentifier(req.params.identifier)
            .then(function(node) {
                if (node && node.id) {
    ...
    NodeApiService.prototype.setNodeWorkflow = function (req) {
