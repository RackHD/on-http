...
function redfishValidatorFactory(
    ...
    RedfishValidator.prototype.getVendorNameById = function(identifier) {
        ...
        return waterline.nodes.getNodeById(identifier)
            .then(function(node){
                ...
                result.node = node;
                result.vendor = _getSystemVendorByIdentifiers(node.identifiers);
                return result;
            });
    };
    function _getSystemVendorByIdentifiers(_identifiers){
        var vendor;
