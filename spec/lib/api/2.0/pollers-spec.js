...
describe('Http.Api.Pollers', function () {
    ...
    describe('non-existent node id', function () {
        ...
        it('should 404 with GET /pollers/:id ', function () {
            return helper.request().get('/api/2.0/pollers/' + badId)
            .expect(404);
        });

        it('should 404 with PATCH /pollers/:id', function () {
            return helper.request().patch('/api/2.0/pollers/' + badId)
            .send()
            .expect(404);
        });

        it('should 404 with DELETE /pollers/:id', function () {
            return helper.request().delete('/api/2.0/pollers/' + badId)
            .expect(404);
        });
    });
    ...
    describe('POST /pollers afterwards', function () {
        ...
        it('should set the pause field to true with PATCH /pollers/:id/pause', function () {
            return helper.request().patch('/api/2.0/pollers/' + poller.id + '/pause')
            .expect('Content-Type', /^application\/json/)
            .expect(200)
            .expect(function (res) {
        ...
        it('should set the pause field to false with PATCH /pollers/:id/resume', function () {
            ...
            .expect(200)
            .then( function () {
                return helper.request().patch('/api/2.0/pollers/' + poller.id + '/resume')
                .expect('Content-Type', /^application\/json/)
                .expect(200)
                .expect(function (res) {
                    expect(res.body).to.have.property('paused', false);
        ...
        it('should delete the poller with DELETE /pollers/:id', function () {
            return helper.request().delete('/api/2.0/pollers/' + poller.id)
                .expect(204);
        });
        ...
        it('should return poller data from GET /pollers/:id/data', function () {
            ...
            return helper.request().get('/api/2.0/pollers/' + poller.id + '/data')
            .expect('Content-Type', /^application\/json/)
        ...
        it('should return poller data from GET /pollers/:id/data', function () {
            ...
            return helper.request().get('/api/2.0/pollers/' + poller.id + '/data/current')
            .expect('Content-Type', /^application\/json/)
